...
CRM_LISTS = {
    ...
    "contacts": {
        ...
        "list_match": "contacts",
        "editable": True,
        "extended_edit": True,      # editor exposes custom-field inputs for editable detail_fields
        "value_field": None,
        "cross_link_deals": False,
        ...
        "detail_fields": [
            ...
            {"key": "phone_2",       "label": "Phone 2",       "editable": True},
            {"key": "address",       "label": "Address",       "editable": True},
            {"key": "crm_item_type", "label": "CRM Item Type", "editable": True},
        ],
        "kpis": {
            "groups": [
                {"key": "completeness",     "label": "Field Completeness", "source": "field_completeness", "chart": "bar", "top": 5},
                {"key": "linked_companies", "label": "Linked Companies",   "source": "linked_companies",   "chart": "bar", "top": 15},
            ],
        },
    },
}
...
def public_registry() -> list[dict]:
    ...
    for key, cfg in CRM_LISTS.items():
        out.append({
            ...
            "extended_edit": cfg.get("extended_edit", False),
