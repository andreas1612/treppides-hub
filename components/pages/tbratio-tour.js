...
const STEPS = [
  ...
  {
    title: "Anything unmapped",
    body: "Accounts the tool couldn't place sit in Unmapped. Drag them onto the right line — a non-zero balance left here is excluded from the statements, and you'll be warned.",
